...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'drkr2.data';
    var REMOTE_PACKAGE_BASE = 'drkr2.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 94050765;
      var PACKAGE_UUID = '8da9539b-a0b9-439f-881d-b52ee212a906';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 91273699, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(91273699, 91274487, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(91274487, 91277988, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(91277988, 93148168, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(93148168, 94023140, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(94023140, 94050765, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_drkr2.data');

    };
    Module['addRunDependency']('datafile_drkr2.data');
